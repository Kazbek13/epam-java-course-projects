 ...
 * @author Andrew
 */
public class CreateFlightInstanceCommand implements Command {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    logger.error("ServletException in CreateFlightInstanceCommand::execute", ex1);
                } catch (IOException ex1) {
                    logger.error("IOException in CreateFlightInstanceCommand::execute", ex1);
                }

            }

        } catch (SQLException ex) {
            logger.error("SQLException in CreateFlightInstanceCommand::execute", ex);
        }

        try {
            response.sendRedirect("flights");
        } catch (IOException ex) {
            logger.error("IOException in CreateFlightInstanceCommand::execute", ex);
        }
